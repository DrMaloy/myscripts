...
A bouncing logo animation. You have to be 'Of a certain age' to
...
try:
    ...
    print('can install by follow the instructions intructions at')
...
# (!) Try changing this list to few colors:
...
def main():
    ...
    while True: # Main program loop.
        for logo in logos:  # Handle each logo in the logos list.
            ...
            # See if the loop bounces off the corner:
            ...
            # See if the loop bounces the bottom edge:
            ...
            if logo[DIR] != originalDirection:
                # Change the color when the color bounces:
                logo[COLOR] = random.choice(COLORS)

            # Move the logo. (X moves by two because of the terminal
...
if __name__ == '__main__':
    try:
        ...
        sys.exit() # When Ctrl-C is pressed, end the progam.
