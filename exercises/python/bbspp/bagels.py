...
the clue will be Fermi Pico.'''.format(NUM_DIGITS))
...
def getSecretNum():
    ...
    # Get the first NUM_DIGITS digits in the listfor the secret number:
    secretNum = ''
...
# if programis run (instead of imported), run the game:
